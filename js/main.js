import { createSaveDialog } from "./save-dialog.js?v=20260311sol6";
import { createAppsMenu } from "./apps-menu.js?v=20260311sol6";
import { createWindowManager } from "./wm.js?v=20260311sol6";
import { initMenuDropdowns, initMenuActions } from "./menubar.js?v=20260311sol6";
import { saveUpload, hasWrappedKey, setPassphrase, unlockWithPassphrase } from "./filesystem.js?v=20260311sol6";
import { initThemeToggle, initThemeState, applyTheme, getTheme, applyWallpaper, getWallpaperName, clearWallpaper } from "./theme.js?v=20260311sol6";
import { createHud } from "./hud.js?v=20260311sol6";
import { initAgent1C } from "./agent1c.js?v=20260311sol6";
import { createVoiceSttController } from "./voice-stt.js?v=20260311sol6";
