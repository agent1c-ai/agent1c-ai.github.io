...
function torInstallBaseUrl(){
  ...
  return "https://agent1c.ai/shell-relay"
}
...
function torSetupByOs(os){
  ...
  const relayHealthCmd = `curl -s -H "Origin: https://agent1c.ai" http://127.0.0.1:8766/v1/health`
  const torStatusCmd = `curl -s -H "Origin: https://agent1c.ai" http://127.0.0.1:8766/v1/tor/status`
  if (os === "mac") {
    return {
      label: "macOS",
      cards: [
      ...
      <div id="torRelayPageTerminal" class="agent-relay-page agent-hidden">
        ...
        <div class="agent-terminal">
          ...
          <div class="agent-terminal-row">
            ...
            <input id="torRelayCommandInput" class="agent-terminal-input" type="text" placeholder="curl -s -H 'Origin: https://agent1c.ai' http://127.0.0.1:8766/v1/tor/status" />
